...
__DEFINE__(1705047825592, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1705047825593,"./event-store":1705047825594}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1705047825593, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1705047825594, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1705047825593,"./utils":1705047825595}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1705047825595, function(require, module, exports) {
...
return __REQUIRE__(1705047825592);
})()
